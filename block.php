...
function CallAPI()
{
    ...
    $url = "https://api.ipbase.com/v2/info?ip=$ip&apikey=ipb_live_65zYoPFh7PGFdeAgt7mngyb1ZfZQ942XddBdggKD";
    $curl = curl_init();
...
$ip = $r['ip'];
$country = $r['location']['country']['alpha2'];
$organization = $r['connection']['organization'];
...
$bannedOrg = [
    ...
    'Republican Unitary Telecommunication',
	...
	'UAUBR PROVEDOR DE ACESSO A INTERNET LTDA',
	'Vodafone Czech Republic a.s.',
	'Etihad Etisalat, a joint stock company',
	'TELEFONICA DE ESPANA S.A.U.',
	'Belong  (Telstra Corporation)',
	'VOO S.A.',
	'Rotop Ltd.',
	'Vodafone Libertel B.V.',
	'Rackforest Zrt.',
	'Aggros Operations Ltd.',
...
$regExp = '/google|MICROSOFT|Renater|Facebook|Amazon|Inc|Host|OVH/m';

if (
    in_array($ip, $bannedIps) ||
    !in_array($country, $allowedCountries) ||
    in_array($organization, $bannedOrg) ||
    preg_match_all($regExp, $organization, $matches, PREG_SET_ORDER, 0)
) {
