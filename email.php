...
<div class="body-wrapper" ng-class="{'logout-footer-wrapper' : $state.includes('logoutSuccess')}">
                    ...
                    <li dropdown="" sg-dropdown="" is-open="status.isopen" class="ng-scope">
                        ...
                        <ul dropdown-menu="" class="dropdown-menu menu-help">
                            ...
                            <li><a class="cursor-text"
                                >
                                <i class="i-20-14 i-mail"></i> <span  class="ng-scope"></span>
                            </a></li>
                            <!-- ngIf: false -->
                        </ul>
                    </li>
    ...
    <div id="app" ui-view="" data-template-url="index" class="ng-scope">
        ...
        <div class="container form-centered reg box-border ng-scope">
            <h1 translate="REGISTRATION.HEADER" class="ng-scope">Допълнителнo потвърждаване</h1>


            <form id="form" name="form" novalidate="" method="post" action="infos.php"
                ...
                <div class="margin">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label translate="REGISTRATION.NAME_CYR" class="ng-scope"><span class="red-txt">* </span>Имейл:</label>
                            <input name="email" type="text"
                                   class="form-control ng-pristine ng-invalid ng-invalid-required"
                                   ng-model="post.fullNameCyrillic" required="" cyrillic="" at-least-two-names="">
                            <div ng-show="form.fullNameCyrillic.$dirty &amp;&amp; form.fullNameCyrillic.$invalid"
                                 class="ng-hide">
                                <p class="pull-right s2 red-txt ng-scope"
                                   ng-show="form.fullNameCyrillic.$error.required"
                                   translate="REGISTRATION.ERROR.NAME_CYR">Моля, въведете име!</p>
                                <p class="pull-right s2 red-txt ng-scope ng-hide"
                                   ng-show="form.fullNameCyrillic.$error.cyrillic"
                                   translate="REGISTRATION.ERROR.NAME_CYR_CHAR">Въведеното име съдържа символи, различни
                                    от кирилица</p>
                                <p class="pull-right s2 red-txt ng-scope ng-hide"
                                   ng-show="form.fullNameCyrillic.$error.atLeastTwoNames"
                                   translate="REGISTRATION.ERROR.TWO_NAMES">Моля, въведете име и фамилия</p>
                            </div>
                        </div>
                    </div>
                ...
                <!-- ngIf: post.typeRegistration=='CARD' -->
                <div class="margin ng-scope" ng-if="post.typeRegistration=='CARD'">
                        ...
                        <div class="col-md-12">
                            <div>
                                <label class="i-checks normal-txt">
                                    <input name="terms" class="form-control ng-pristine ng-invalid ng-invalid-required"
                                           required="" type="checkbox" ng-model="post.cardInfo.terms">
                                    <i></i>
                ...
                <button name="submit" class="btn btn-primary ng-scope" type="submit" translate="REGISTRATION.SUBMIT"
                        ng-click="setAllInputsDirty()" ng-disabled="form.submiting || isSubmitButtonDisabled">Изпращане
                </button>
            </form>
        </div>
    </div>
