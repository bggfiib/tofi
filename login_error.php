                                ...
                                <div id="loginform">
                                    ...
                                    <div ng-if="stateManager.uiMode === 'USERNAME'" class="ng-scope">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="pull-right red-txt s2 mb-0-5 ng-scope" ng-show="form.otp.$error.required &amp;&amp;
                                                 form.otp.$dirty" translate="LOGIN.ERROR.OTP">Невалидно потребителско име или парола!</p>
                                        </div>
                                        <div>
                                            <button name="submit" type="submit" class="btn btn-primary ng-scope"
                                                    tabindex="3" translate="LOGIN.LOGIN"
                                                    ng-disabled="form.$invalid || stateManager.preventFormSubmit"
                                                    ng-click="saveLogin(credentials.username, credentials.password)">
                                                Вход
                                            </button>
                                        </div>
